...
class Chef
  class Resource::Vtm_global_settings < Resource::VtmRest
    ...
    attribute :path, kind_of: String, default: "/api/tm/3.8/config/active/global_settings"
    ...
    attribute :basic__cluster_identifier, kind_of: String, default: ''
    ...
    attribute :auditlog__via_eventd, kind_of: [TrueClass, FalseClass], default: false
    ...
    attribute :fault_tolerance__child_timeout, kind_of: Fixnum, default: 5
    ...
    attribute :remote_licensing__registration_server, kind_of: String, default: ''
    attribute :remote_licensing__server_certificate, kind_of: String, default: ''
    ...
    attribute :security__login_delay, kind_of: Fixnum, default: 4
...
class Chef
  class Provider::Vtm_global_settings < Provider::VtmRest
    def load_current_resource
      ...
      @configHash[:basic__cluster_identifier] = new_resource.basic__cluster_identifier
      ...
      @configHash[:auditlog__via_eventd] = new_resource.auditlog__via_eventd
      ...
      @configHash[:fault_tolerance__child_timeout] = new_resource.fault_tolerance__child_timeout
      ...
      @configHash[:remote_licensing__registration_server] = new_resource.remote_licensing__registration_server
      @configHash[:remote_licensing__server_certificate] = new_resource.remote_licensing__server_certificate
