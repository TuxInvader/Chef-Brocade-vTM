...
class Chef
  class Resource::Vtm_traffic_managers < Resource::VtmRest
    ...
    attribute :path, kind_of: String, default: "/api/tm/3.8/config/active/traffic_managers/"
    ...
    attribute :basic__appliance_card, kind_of: [Array, String], default: []
    ...
    attribute :appliance__ipmi_lan_access, kind_of: [TrueClass, FalseClass], default: false
    attribute :appliance__ipmi_lan_addr, kind_of: String, default: ''
    attribute :appliance__ipmi_lan_gateway, kind_of: String, default: ''
    attribute :appliance__ipmi_lan_ipsrc, kind_of: String, default: 'static'
    attribute :appliance__ipmi_lan_mask, kind_of: String, default: ''
    attribute :appliance__ipv4_forwarding, kind_of: [TrueClass, FalseClass], default: false
    attribute :appliance__ipv6_forwarding, kind_of: [TrueClass, FalseClass], default: false
    ...
    attribute :appliance__ssh_password_allowed, kind_of: [TrueClass, FalseClass], default: true
    ...
    attribute :remote_licensing__email_address, kind_of: String, default: ''
    attribute :remote_licensing__message, kind_of: String, default: ''
...
class Chef
  class Provider::Vtm_traffic_managers < Provider::VtmRest
    def load_current_resource
      ...
      @configHash[:basic__appliance_card] = new_resource.basic__appliance_card
      ...
      @configHash[:appliance__ipmi_lan_access] = new_resource.appliance__ipmi_lan_access
      @configHash[:appliance__ipmi_lan_addr] = new_resource.appliance__ipmi_lan_addr
      @configHash[:appliance__ipmi_lan_gateway] = new_resource.appliance__ipmi_lan_gateway
      @configHash[:appliance__ipmi_lan_ipsrc] = new_resource.appliance__ipmi_lan_ipsrc
      @configHash[:appliance__ipmi_lan_mask] = new_resource.appliance__ipmi_lan_mask
      @configHash[:appliance__ipv4_forwarding] = new_resource.appliance__ipv4_forwarding
      @configHash[:appliance__ipv6_forwarding] = new_resource.appliance__ipv6_forwarding
      ...
      @configHash[:appliance__ssh_password_allowed] = new_resource.appliance__ssh_password_allowed
      ...
      @configHash[:remote_licensing__email_address] = new_resource.remote_licensing__email_address
      @configHash[:remote_licensing__message] = new_resource.remote_licensing__message
