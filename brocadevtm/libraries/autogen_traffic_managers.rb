...
class Chef
  class Resource::Vtm_traffic_managers < Resource::VtmRest
    ...
    attribute :path, kind_of: String, default: "/api/tm/3.3/config/active/traffic_managers/"
    ...
    attribute :appliance__ntpservers, kind_of: [Array, String], default: ["0.riverbed.pool.ntp.org", "1.riverbed.pool.ntp.org", "2.riverbed.pool.ntp.org", "3.riverbed.pool.ntp.org"]
