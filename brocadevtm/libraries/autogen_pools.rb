...
class Chef
  class Resource::Vtm_pools < Resource::VtmRest
    ...
    attribute :path, kind_of: String, default: "/api/tm/3.8/config/active/pools/"
    ...
    attribute :udp__response_timeout, kind_of: Fixnum, default: 0
...
class Chef
  class Provider::Vtm_pools < Provider::VtmRest
    def load_current_resource
      ...
      @configHash[:udp__response_timeout] = new_resource.udp__response_timeout
