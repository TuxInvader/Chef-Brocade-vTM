...
class Chef
  class Resource::Vtm_virtual_servers < Resource::VtmRest
    ...
    attribute :path, kind_of: String, default: "/api/tm/3.8/config/active/virtual_servers/"
    ...
    attribute :basic__autodetect_upgrade_headers, kind_of: [TrueClass, FalseClass], default: true
    ...
    attribute :dns__edns_client_subnet, kind_of: [TrueClass, FalseClass], default: true
    attribute :dns__edns_udpsize, kind_of: Fixnum, default: 4096
    attribute :dns__max_udpsize, kind_of: Fixnum, default: 4096
    attribute :dns__rrset_order, kind_of: String, default: 'fixed'
    ...
    attribute :gzip__etag_rewrite, kind_of: String, default: 'wrap'
    ...
    attribute :http2__connect_timeout, kind_of: Fixnum, default: 0
    attribute :http2__data_frame_size, kind_of: Fixnum, default: 4096
    attribute :http2__enabled, kind_of: [TrueClass, FalseClass], default: true
    attribute :http2__header_table_size, kind_of: Fixnum, default: 4096
    attribute :http2__headers_index_blacklist, kind_of: [Array, String], default: []
    attribute :http2__headers_index_default, kind_of: [TrueClass, FalseClass], default: true
    attribute :http2__headers_index_whitelist, kind_of: [Array, String], default: []
    attribute :http2__idle_timeout_no_streams, kind_of: Fixnum, default: 120
    attribute :http2__idle_timeout_open_streams, kind_of: Fixnum, default: 600
    attribute :http2__max_concurrent_streams, kind_of: Fixnum, default: 200
    attribute :http2__max_frame_size, kind_of: Fixnum, default: 16384
    attribute :http2__max_header_padding, kind_of: Fixnum, default: 0
    attribute :http2__merge_cookie_headers, kind_of: [TrueClass, FalseClass], default: true
    attribute :http2__stream_window_size, kind_of: Fixnum, default: 65535
    ...
    attribute :ssl__server_cert_alt_certificates, kind_of: [Array, String], default: []
...
class Chef
  class Provider::Vtm_virtual_servers < Provider::VtmRest
    def load_current_resource
      ...
      @configHash[:basic__autodetect_upgrade_headers] = new_resource.basic__autodetect_upgrade_headers
      ...
      @configHash[:dns__edns_client_subnet] = new_resource.dns__edns_client_subnet
      @configHash[:dns__edns_udpsize] = new_resource.dns__edns_udpsize
      @configHash[:dns__max_udpsize] = new_resource.dns__max_udpsize
      @configHash[:dns__rrset_order] = new_resource.dns__rrset_order
      ...
      @configHash[:gzip__etag_rewrite] = new_resource.gzip__etag_rewrite
      ...
      @configHash[:http2__connect_timeout] = new_resource.http2__connect_timeout
      @configHash[:http2__data_frame_size] = new_resource.http2__data_frame_size
      @configHash[:http2__enabled] = new_resource.http2__enabled
      @configHash[:http2__header_table_size] = new_resource.http2__header_table_size
      @configHash[:http2__headers_index_blacklist] = new_resource.http2__headers_index_blacklist
      @configHash[:http2__headers_index_default] = new_resource.http2__headers_index_default
      @configHash[:http2__headers_index_whitelist] = new_resource.http2__headers_index_whitelist
      @configHash[:http2__idle_timeout_no_streams] = new_resource.http2__idle_timeout_no_streams
      @configHash[:http2__idle_timeout_open_streams] = new_resource.http2__idle_timeout_open_streams
      @configHash[:http2__max_concurrent_streams] = new_resource.http2__max_concurrent_streams
      @configHash[:http2__max_frame_size] = new_resource.http2__max_frame_size
      @configHash[:http2__max_header_padding] = new_resource.http2__max_header_padding
      @configHash[:http2__merge_cookie_headers] = new_resource.http2__merge_cookie_headers
      @configHash[:http2__stream_window_size] = new_resource.http2__stream_window_size
      ...
      @configHash[:ssl__server_cert_alt_certificates] = new_resource.ssl__server_cert_alt_certificates
